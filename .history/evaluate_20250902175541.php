...
<?php
	...
	$insertinvigilator_data = $conn->query(
		"INSERT INTO `invigilator_evaluated` (`invigilator_id`,`role`,`action`, `candidate_id`, `evalution_starttime`,`ip_address`) 
		 VALUES ('{$factId}', 'invigilator', '{$action}', '{$invigilator_id}', '".date('Y-m-d H:i:s')."','{$ip_address}')"
	);
