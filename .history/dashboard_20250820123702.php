...
<?php
$getCandidateData    =   mysqli_query($conn,'SELECT c.* FROM `pe_candidates` as c JOIN pe_assign_candidates as ac ON ac.candidate_id = c.id WHERE ac.invigilator_id ='.$_SESSION['FactId'].' ');
$candidate = array();
