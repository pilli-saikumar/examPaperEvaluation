...
<?php
	...
	$insertinvigilator_data = $conn->query("INSERT INTO `invigilator_evaluated` (`invigilator_id`, `candidate_id`, `evaluation_starttime`,`exam_id`,`subject_id`) 
		 VALUES ( '{$factId}', '{$HidId}', '".date('Y-m-d H:i:s')."', '".$exam_id."', '".$subject_id."')");
...
<html>
	...
	<body >
		...
		<div id="ans-script-div" style="display:inline-block;">
