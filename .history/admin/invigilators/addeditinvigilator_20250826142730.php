    ...
    if(isset($_POST['invigilator_email']) && !empty($_POST['invigilator_email'])){
        ...
        if(mysqli_num_rows($getExistInvigilatorData) == 0){
            if(isset($_POST['id']) && !empty($_POST['id'])){
                ...
                `invigilator_phone`='".$param['invigilator_phone']."',`subject`='".$param['subject']."',`update_date`='".$creation_date."',`updated_by`='Admin',`updated_ip_address`='".$creation_ip."' ".$set." WHERE id=".$_POST['id']." ";
                $insertData        =   mysqli_query($conn,$updateQuery);
            }
            else{
                $insertQuery = "INSERT INTO `pe_invigilators`(`invigilator_name`, `invigilator_email`, `invigilator_phone`, `subject`, `creation_date`, `creation_ip_address`, `created_by`, `status`, `password`) 
                VALUES ('".$param['invigilator_name']."','".$param['invigilator_email']."','".$param['invigilator_phone']."',
                '".$param['subject']."','".$creation_date."','".$creation_ip."','admin','A','".$param['password']."')";
...
?>
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" name="role" id="role" required>
                                        ...
                                        <option value="head_evaluator">Head Evaluator</option>
                        ...
                        <div class="row">
                             ...
                             <div class="form-group">
                                    ...
                                    <select class="form-control" name="subject_id" id="subject_id" required onchange="getsubjectName">
  ...
  <script>
    ...
    function getsubjectName(){
        ...
        var url = "<?php echo BASE_URL?>invigilators/getsubjectName.php?exam_id="+exam_id+"&subject_id="+subject_id;
