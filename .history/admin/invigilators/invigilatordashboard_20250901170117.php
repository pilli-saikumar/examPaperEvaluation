...
$query = "SELECT in.id as invigilator_id, in.invigilator_name, in.invigilator_email,  in.exam_id, in.subject_id, in.status FROM `pe_assign_candidates` WHERE `invigilator_id` = "
