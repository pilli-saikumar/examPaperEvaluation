...
<div class="container-scroller">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(document).on('change', '.invigilator-checkbox', function() {
                            ...
                            var assignedCount = $('.assign_candidate_count').val();
  ...
  var totalcandidatecount = $('.assign_candidate_count').val();
    
    console.log(`Invigilator ID: ${invigilatorId}, Assigned Count: ${count}`);
