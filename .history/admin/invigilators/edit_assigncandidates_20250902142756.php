...
$getinvigilator = mysqli_query($conn,'SELECT * FROM pe_invigilators WHERE id != '.$uid.'');
...
$current_invigilator = mysqli_query($conn,'SELECT * FROM pe_invigilators WHERE subject = '.$subject_id.' AND exam_id = '.$exam_id.'');
