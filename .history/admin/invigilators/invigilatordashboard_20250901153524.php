...
$invigilatorassigndata =mysqli_query($conn,'SELECT s.subject_name,i.* FROM `pe_assign_candidates` as i JOIN pe_subjects as s ON s.id=i.exam_id ORDER BY id DESC');
