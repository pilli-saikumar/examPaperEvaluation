...
AND (status IS NULL OR status = 'in process')";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $_SESSION['success'] = "Successfully updated " . $rows_affected . " records.";
        header("Location:../invigilators/invigilatordashboard.php");
    } else {
        echo "Error: " . mysqli_error($conn);
        $_SESSION['error'] = "Error: " . mysqli_error($conn);
        header("Location: edit_assigncandidates.php?uid=" . $uid);
    }
