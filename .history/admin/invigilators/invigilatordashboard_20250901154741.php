...
$getInvgilatorData =mysqli_query($conn,'SELECT* FROM `pe_assign_candidates` as ac JOIN pe_invigilators as i ON i.id=ac.invigilator_id JOIN pe_subjects as s ON s.id=i.exam_id GROUP BY ac.invigilator_id  ORDER BY id DESC');
...
C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\invigilatordashboard.php(4): mysqli_query(Object(mysqli), 'SELECT* FROM `p...') #1 {main} thrown in C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\invigilatordashboard.php on line 4
?>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $invigilator['assigned_candidates']?></td>
