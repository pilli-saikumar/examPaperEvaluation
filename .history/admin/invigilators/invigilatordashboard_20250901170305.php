...
$query = "SELECT in.id as invigilator_id, in.invigilator_name, in.invigilator_email,  in.exam_id, in.subject_id, pe_subjects.subject_name,pe_question_paper FROM `pe_assign_candidates` WHERE `invigilator_id` = "
