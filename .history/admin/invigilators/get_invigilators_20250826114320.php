...
//     $output .= "<div class='form-check mb-2 border-bottom pb-2'>";
...
//         $output .= "<label class='form-check-label ms-2 ml-2' for='invigilator_".$invigilator['id']."'>".ucfirst($invigilator['invigilator_name'])."</label>";
//         $output .= "</div>";
//     }
//     $output .= "</div></div>";
// }
if ($getInvigilatorData) {
    ...
    // Select All checkbox
    $output .= "<div class='form-check mb-3 border-bottom pb-2'>";
    $output .= "<input class='form-check-input' type='checkbox' id='selectAllInvigilators'>";
    $output .= "<label class='form-check-label fw-bold ms-2' for='selectAllInvigilators'>Select All Invigilators</label>";
    $output .= "</div>";
    ...
    while ($invigilator = mysqli_fetch_assoc($getInvigilatorData)) {
        ...
        $output .= "<div class='form-check'>";
        $output .= "<input class='form-check-input invigilator-checkbox' type='checkbox' name='invigilator_id[]' value='".$invigilator['id']."' id='invigilator_".$invigilator['id']."'>";
        $output .= "<label class='form-check-label ms-' for='invigilator_".$invigilator['id']."'>".ucfirst($invigilator['invigilator_name'])."</label>";
        $output .= "</div>";
        $output .= "</div>";
