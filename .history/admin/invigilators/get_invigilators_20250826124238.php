...
if ($getInvigilatorData) {
    ...
    while ($invigilator = mysqli_fetch_assoc($getInvigilatorData)) {
        $output .= "<div class='form-check mb-2 ml-2'>";
        ...
        $output .= "<label class='form-check-label ms-2 ml-2 fw-bold' for='invigilator_".$invigilator['id']."'>".ucfirst($invigilator['invigilator_name'])."</label>";
        $output .= "</div>";
    }
    $output .= "</div></div>";
}
