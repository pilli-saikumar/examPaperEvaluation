...
if(isset($_POST['saveChanges'])){
    ...
    $getcurrentinvigilator = mysqli_query($conn,'SELECT * FROM pe_invigilators WHERE id = '.$current_invigilator.'');
    if(mysqli_num_rows($getcurrentinvigilator) > 0){
        $current_invigilator_name = mysqli_fetch_assoc($getcurrentinvigilator);
    }
