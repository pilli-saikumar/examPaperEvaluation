    ...
    if (subject_id && exam_id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Split response into options + count
                var parts = response.split('||COUNT||');
                ...
                if (parts.length === 2) {
                    ...
                    // Destroy existing multiselect (if already initialized)
                    ...
                    // Reinitialize Bootstrap Multiselect with checkbox + select all
                    $select.multiselect({
                        buttonWidth: '100%',
                        includeSelectAllOption: true,
                        enableFiltering: true,
                    ...
                    // Show hidden div now that we have data
                    $('#invigilator').show();
                } else {
