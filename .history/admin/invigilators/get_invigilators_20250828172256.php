...
if ($getInvigilatorData) {
    ...
    while ($invigilator = mysqli_fetch_assoc($getInvigilatorData)) {
        ...
        $output .= "<input class='form-control ml-2 assign_candidate_count' type='number' name='assign_candidate_count[]' value='a' placeholder='Assign Candidate Count' id='assign_candidate_count_".$invigilator['id']."'>";
        $output .= "</div>";
    }
    $output .= "</div></div>";
}
