...
$result = mysqli_query($conn, "SELECT in.invigilator_name,in.invigilator_email,ac.* FROM `pe_assign_candidates`  JOIN pe_invigilators in ON in.id = pe_assign_candidates.invigilator_id   group by invigilator_id ORDER BY id DESC");
