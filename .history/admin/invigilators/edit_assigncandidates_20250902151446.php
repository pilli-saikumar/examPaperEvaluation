...
$invigilator = [];
if (mysqli_num_rows($getassigneddata) > 0) {
    // Since you're using a single UID, you should fetch all rows to use them later
    // Let's just fetch the first one for the form fields
    $invigilator = mysqli_fetch_assoc($getassigneddata);
}
