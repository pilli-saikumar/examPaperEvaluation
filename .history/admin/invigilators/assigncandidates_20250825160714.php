                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-3 col-sm-3 col-lg-3" style="display: none;" id="invigilator">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-3 col-lg-3" style="display: none;" id="candidate_assign_count">
                                                      <div class="form-group">
                                                        <label for="candidate_assign_count">invigilator Name</label>
                                                        <div id="invigilator_name"></div>
            ...
            if (subject_id && exam_id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (parts.length === 2) {
                         $('#invigilator_name').html('<div>'+optionsHtml+'</div>');   
                            // Crucial Step: Rebuild the multiselect after updating the HTML
