    ...
    if(isset($_POST['invigilator_email']) && !empty($_POST['invigilator_email'])){
        ...
        if(mysqli_num_rows($getExistInvigilatorData) == 0){
            if(isset($_POST['id']) && !empty($_POST['id'])){
                ...
                `invigilator_phone`='".$param['invigilator_phone']."',`subject`='".$param['subject']."',1`update_date`='".$creation_date."',`updated_by`='Admin',`updated_ip_address`='".$creation_ip."' ".$set." WHERE id=".$_POST['id']." ";
