            ...
            if (subject_id && exam_id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(document).on('change', '.assign_candidate_count', function() {
                          var assign_candidate_count = $(this).val();
                          var invigilator_id = $(this).attr('id');
                          console.log(assign_candidate_count, invigilator_id);
                        });
