                        ...
                        <div class="row">
                             <div class="col-md-6 col-sm-6 col-lg-6">
                               ...
                               <div class="form-group"><label for="exam_id">Exam</label>
                                            ...
                                            </div>Fatal error: Cannot redeclare authenticateUser() (previously declared in C:\xampp\htdocs\examPaperEvaluation\admin\helper.php:2) in C:\xampp\htdocs\examPaperEvaluation\admin\helper.php on line 2
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                              <div class="form-group">
                                    <label for="exampleInputUsername1">Choose Subject</label>
                                    <?php echo isset($invigilator['subject']) ? getSubjectName($invigilator['subject']) : ''?>
