                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="assign_candidates" id="assign_candidates" required>
                                                    <?php if (isset($invigilatorslist) && !empty($invigilatorslist)) { ?>
                                                        ...
                                                        <option value="<?php echo $invigilatorslist['id'] ?>" <?php echo $invigilatorslist['id'] == $invigilator['assign_candidates'] ? 'selected' : '' ?>><?php echo ucfirst($invigilatorslist['invigilator_name']) ?></option>
                                                    <?php } ?>
                                                    <?php } ?>
