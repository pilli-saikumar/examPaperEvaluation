                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo BASE_URL;?>invigilators/viewassignedcandidates.php?uid=<?php echo $invigilator['id']?>" class="btn btn-primary btn-sm">View</a>
                            <a href="<?php echo BASE_URL;?>invigilators/addeditinvigilator.php?uid=<?php echo $invigilator['id']?>" class="btn btn-primary btn-sm">Edit</a>
