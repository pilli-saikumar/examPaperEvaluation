...
if(mysqli_num_rows($getinvigilator) > 0){
    while($invigilatorData   =   mysqli_fetch_assoc($getinvigilator)){
        $invigilatorlist[]       =    $invigilatorData;
    }
}
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Assign Candidates</h4>
                                  <?php echo "<pre>"; print_r($invigilatorlist); die; ?>   
                                        ...
                                        <div class="col-md-3 col-sm-3 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="assign_candidates" id="assign_candidates" required>
                                                    <?php if (isset($invigilatorlist) && !empty($invigilatorlist)) { ?>
                                                        <option value="<?php echo $invigilatorlist['id'] ?>"><?php echo ucfirst($invigilatorlist['invigilator_name']) ?></option>
                                                    <?php } ?>
