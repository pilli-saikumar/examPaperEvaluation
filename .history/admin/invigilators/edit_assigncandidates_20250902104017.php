...
$getInvigilatorData    =   mysqli_query($conn,'SELECT * FROM pe_assign_candidates WHERE invigilator_id = '.$uid.' AND exam_id = '.$exam_id.' AND subject_id = '.$subject_id.'' GROUP BY ac.invigilator_id
ORDER BY ac.id DESC"); );
