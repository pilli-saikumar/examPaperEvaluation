...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['exam_id']) && !empty($_POST['exam_id'])) {
      ...
      $query = "SELECT 
                  t1.invigilator_id,t1.exam_id,t1.subject_id,
                  t2.invigilator_name,
                  t3.subject_name,
                  t4.question_paper,
...
?>
  <div class="container-scroller">
    ...
    <select name="exam_id" id="exam_id" class="form-control" onchange="this.form.submit()">
        ...
        <a href="<?php echo BASE_URL; ?>invigilators/edit_assigncandidates.php?uid=<?php echo $invigilator['invigilator_id']; ?>&exam_id=<?php echo $invigilator['exam_id']; ?>&subject_id=<?php echo $invigilator['subject_id']; ?>" class="btn btn-primary btn-sm">Edit</a>
    <?php } else { ?>
