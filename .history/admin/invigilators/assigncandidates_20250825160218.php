                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" name="currentDataForm" id="currentDataForm" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-3 col-sm-3 col-lg-3" id="invigilator_name" style="display: none;">
                                                    <div class="form-group">
                                                        <label>Invigilators</label>
                                                        <div id="invigilator_checkboxes"></div>
                                                    </div>
                                               </div> -->
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (parts.length === 2) {
                        ...
                        $('#invigilator_name').show();
                        // Set the checkboxes HTML
                        $('#invigilator_checkboxes').html(optionsHtml);
                        $('#candidateCount').html("Total Candidates: " + candidateCount);
                    } else {
                        $('#candidateCount').html("Total Candidates: 0");
                        $('#invigilator_name').hide();
                    }
                },
                error: function() {
                    $select.html('<option value="">Error loading invigilators</option>');
