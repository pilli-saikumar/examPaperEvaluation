...
if(mysqli_num_rows($current_invigilator) > 0){
    $current_invigilator = mysqli_fetch_assoc($current_invigilator);
}
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" name="currentDataForm" id="currentDataForm" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <?php echo $current_invigilator['invigilator_name'];
die; foreach ($invigilatorslist as $invigilatorItem) { ?>
