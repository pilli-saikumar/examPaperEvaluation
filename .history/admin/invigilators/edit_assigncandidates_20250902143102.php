...
$getinvigilator = mysqli_query($conn,'SELECT * FROM pe_invigilators WHERE exam_id = '.$exam_id.' AND subject_id = '.$subject_id.'');
...
Fatal error: Uncaught mysqli_sql_exception: Unknown column 'subject_id' in 'where clause' in C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\edit_assigncandidates.php:29 Stack trace: #0 C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\edit_assigncandidates.php(29): mysqli_query(Object(mysqli), 'SELECT * FROM p...') #1 {main} thrown in C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\edit_assigncandidates.php on line 29
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="current_assign" id="current_assign" value="<?php echo $current_invigilator_name['invigilator_name'] ?>" readonly>
