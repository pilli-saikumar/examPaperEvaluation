...
$sql = "
SELECT ac.*, i.name, i.email, i.phone 
...
C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\invigilatordashboard.php(12): mysqli_query(Object(mysqli), '\r\nSELECT ac.*, ...') #1 {main} thrown in C:\xampp\htdocs\examPaperEvaluation\admin\invigilators\invigilatordashboard.php on line 12
echo "<pre>";
print_r($invigilator);
die;
